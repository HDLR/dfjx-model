        ...
        this.$http({
          ...
          if (!this.dataForm.id) {
            ...
            this.$http({
              ...
              this.dataForm.id = data.menuList.menuId
              this.dataForm.type = data.menuList.type
              this.dataForm.name = data.menuList.name
              this.dataForm.parentId = data.menuList.parentId
              this.dataForm.url = data.menuList.url
              this.dataForm.perms = data.menuList.perms
              this.dataForm.orderNum = data.menuList.orderNum
              this.dataForm.icon = data.menuList.icon
              this.menuListTreeSetCurrentNode()
            })
          }
        })
